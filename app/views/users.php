                    ...
                    <div class="d-flex flex-row align-items-center">
                        ...
                        <div class="info-card-text flex-1">
                            ...
                            <a href="javascript:void(0);" class="fs-xl text-truncate text-truncate-lg text-info" data-toggle="dropdown" aria-expanded="false">
                                <?php if($admin || $current_user == $user['id']):?>
                            ...
                            <?php if($admin || $current_user == $user['id']):?>
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="/user/edit/<?=$user['id']?>">
                                        ...
                                        Редактировать</a>
                                    <a class="dropdown-item" href="/user/security/<?=$user['id']?>">
                                        <i class="fa fa-lock"></i>
                                        Безопасность</a>
                                    <a class="dropdown-item" href="/user/status/<?=$user['id']?>">
                                        <i class="fa fa-sun"></i>
                                        Установить статус</a>
                                    <a class="dropdown-item" href="/user/media/<?=$user['id']?>">
